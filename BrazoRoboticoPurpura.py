...
slider6 = tk.Scale(page1, from_=110, to=180, orient=tk.HORIZONTAL, length=300, command=lambda val: updateSlider6(val), bg="#273746", fg="white")   #95 es cierre maximo
...
def updateSlider4(val):
   ...
   # enviar angulo servo 4
    #er.write(f"servo4:{slider4Value}\n".encode())
...
grip1_button = tk.Button(page2, text="Abrir Grip", command=lambda: grip1(), width=20, height=3, bg="#273746", fg="white")
grip1_button.grid(row=0, column=0, padx=20, pady=20)

grip2_button = tk.Button(page2, text="Cerrar Grip", command=lambda: grip2(), width=20, height=3, bg="#273746", fg="white")
grip2_button.grid(row=0, column=1, padx=20, pady=20)

up_button = tk.Button(page2, text="Up", command=lambda: up(), width=20, height=3, bg="#273746", fg="white")
up_button.grid(row=1, column=0, padx=20, pady=20)

down_button = tk.Button(page2, text="Down", command=lambda: down(), width=20, height=3, bg="#273746", fg="white")
down_button.grid(row=1, column=1, padx=20, pady=20)

side1_button = tk.Button(page2, text="Side1", command=lambda: side1(), width=20, height=3, bg="#273746", fg="white")
side1_button.grid(row=2, column=0, padx=20, pady=20)

side2_button = tk.Button(page2, text="Side2", command=lambda: side2(), width=20, height=3, bg="#273746", fg="white")
side2_button.grid(row=2, column=1, padx=20, pady=20)
